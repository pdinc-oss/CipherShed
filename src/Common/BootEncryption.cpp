...
#if defined (TCMOUNT)
		static ICipherShedMainCom *ElevatedComInstance;
#elif defined (VOLFORMAT)
		static ICipherShedFormatCom *ElevatedComInstance;
#endif
...
#if defined (TCMOUNT)
	ICipherShedMainCom *Elevator::ElevatedComInstance;
#elif defined (VOLFORMAT)
	ICipherShedFormatCom *Elevator::ElevatedComInstance;
#endif
...
#	error PRAND_DISK_WIPE_PASSES > RNG_POOL_SIZE
	...
	void BootEncryption::RegisterSystemFavoritesService (BOOL registerService)
	{
		...
		if (registerService)
		{
			...
			description.lpDescription = "Mounts CipherShed system favorite volumes.";
